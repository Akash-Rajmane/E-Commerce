...
const About = () => {
  ...
  <>
    ...
    <div className='mt-4 p-4'>
        <img src={"https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png"} alt={"band"} style={{width:"200px", height:"200px", borderRadius:"50%"}} className='float-start m-4'/>
        <p className='p-4'>
